...
const variantStyle = {
  ...
  secondary:
    "w-full h-[170px] px-4 py-4 bg-background rounded-xl shadow-xl border border-gray-800 transition duration-300 ease-in-out hover:shadow-2xl hover:scale-105 hover:opacity-80",
};
